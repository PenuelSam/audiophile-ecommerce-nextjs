...
import type { OrderPayloadInput } from '@/lib/validation';
...
<body style="font-family: Arial, sans-serif; background-color: #f9fafb; margin: 0; padding: 0;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" role="presentation" align="center" style="background:#ffffff; border-radius:12px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px; color:#101010;">
              ...
              <p style="font-size:15px; line-height:1.6; margin:0 0 24px;">We’re getting your order ready to be shipped. We will notify you when it has been sent.</p>
              ...
              <div style="margin-top:32px;">
                <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://audiophile.example.com'}/order/${orderId}" style="display:inline-block; padding:12px 24px; background:#D87D4A; color:#ffffff; text-decoration:none; text-transform:uppercase; font-weight:bold; letter-spacing:1px; border-radius:6px;">View your order</a>
              </div>
  ...
  await resend.emails.send({
    from: 'Audiophile <orders@audiophile.app>',
    to: customer.email,
