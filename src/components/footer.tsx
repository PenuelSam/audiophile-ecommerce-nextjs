    ...
    <footer className="bg-black text-white">
      <div className="container-width">
        ...
        <div className="grid gap-10 pb-14 md:grid-cols-2 md:items-end">
          <p className="text-[15px] leading-[25px] font-medium text-white/50">
        ...
        <p className="pb-10 text-[15px] leading-[25px] font-bold text-white/50">Copyright {new Date().getFullYear()} Audiophile. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
